          ...
          <div className="w-full md:w-2/3">
            <div>
              <p className="text-[#adff85] hover:text-white transition-all duration-500 font-robotoMono flex items-center gap-3 cursor-pointer">
                <span className="border-l-2 border-[#adff85] h-4 w-0.5"></span>{" "}
            ...
            <div className="flex justify-between items-center border-b border-[#c2f3a92a] text-sm">
              {["React", "Angular", "CSS", "Saas"].map((tab) => (
                <div
                  ...
                  className={`w-full border-r border-[#c2f3a92a] last:border-0`}
                  key={tab}
                >
                  <button
                    className={`w-full p-4 transition-all cursor-pointer ${
                      activeTab === tab
                        ? "text-white bg-[#c2f3a92d]"
                        : "text-gray-400"
                    }`}
                  >
                    {tab}
...
export default codepunk;`}</code>
            </pre>

            <div className="flex justify-between items-center p-4 border-t border-[#c2f3a92a]">
              <div className="text-sm flex justify-center gap-2 text-gray-400 hover:text-white transition-all duration-500 z-10 cursor-pointer">
                Documentation{" "}
