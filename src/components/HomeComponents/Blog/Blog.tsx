  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center w-full pt-12">
        <button className="flex justify-center items-center cursor-pointer rounded-xl px-6 py-3 text-sm font-medium uppercase border border-[#afa19c] hover:border-[#ff791ff8] bg-[#c2f3a90a] text-white shadow-sm font-robotoMono hover:text-[#ff5f1f]">
          Explore Blog <MdOutlineKeyboardArrowRight className="text-xl" />{" "}
        </button>
      </div>
    </div>
  );
